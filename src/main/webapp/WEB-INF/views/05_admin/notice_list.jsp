						...
						<table class="coltable">
							...
							<c:otherwise>
								<c:forEach var="i" begin="0" end="${noticeList.list.size()-1}">
									<tr>
										<td><a href="/man/notice/modify.html?page=${param.page }&noticeSeq=${noticeList.list[i].noticeSeq}&searchType=${param.searchType}&searchValue=${param.searchValue}">${noticeList.list[i].noticeName}</a></td>
