						...
						<tr>
							...
							<td>
								<div class="radio_area">
									<input name="loginGb" id="um_1" type="radio" value="1" <c:if test="${'1' eq appVO.loginGb }">checked="checked"</c:if>> <label for="u_y"><spring:message code='app.modify.text30' /></label>
									<input name="loginGb" id="um_2" type="radio" value="2" <c:if test="${'2' eq appVO.loginGb }">checked="checked"</c:if>> <label for="u_n"><spring:message code='app.modify.text31' /></label>
